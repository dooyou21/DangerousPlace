...
public class NMapCalloutCustomOldOverlay extends NMapCalloutOverlay {
    private static final String LOG_TAG = "CalloutCustomOverlay";
    ...
    private static final float CALLOUT_PADDING_Y = 9.33F;
    private static final float CALLOUT_MIMIMUM_WIDTH = 63.33F;
    private static final float CALLOUT_TOTAL_HEIGHT = 50.0F;
